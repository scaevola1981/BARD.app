const judete = [
    {
        id: 1,
        judet: "Alba",
        cities: ["Alba Iulia", "Aiud", "Blaj", "Cugir"],
        comune: ["Galda de Jos", "Mircesti", "Lunca Mureșului"],
      ...
      },
      {
        id: 2,
        judet: "Arad",
        cities: ["Arad", "Ineu", "Lipova", "Sebiș", "Pâncota", "Curtici"],
        comune: ["Fântânele", "Zădăreni", "Vinga"],
      ...
      },
      {
        ...
        comune: ["Băiculești", "Bârla", "Călinești"],
      ...
      },
      {
        id: 4,
        judet: "Bacău",
        cities: ["Bacău", "Onești", "Moinești", "Comănești", "Târgu Ocna"],
        comune: ["Colonești", "Scorțeni", "Hălăucești"],
      ...
      },
      {
        id: 5,
        judet: "Bihor",
        cities: ["Oradea", "Beiuș", "Marghita", "Salonta", "Aleșd", "Valea lui Mihai"],
        comune: ["Diosig", "Lunca", "Șuncuiuș"],
      ...
      },
      {
        ...
        comune: ["Dumitra", "Zagra", "Măgura Ilvei"],
      ...
      },
      {
        id: 7,
        judet: "Brașov",
        cities: ["Brașov", "Făgăraș", "Râșnov", "Săcele", "Zărnești", "Codlea", "Victoria", "Predeal"],
        comune: ["Rupea", "Sânpetru", "Hărman"],
      ...
      },
      {
        ...
        comune: ["Voluntari", "Pantelimon", "Berceni"],
      ...
      },
      {
        id: 9,
        judet: "Cluj",
        cities: ["Cluj-Napoca", "Turda", "Dej", "Gherla", "Huedin", "Florești", "Apahida", "Baciu"],
        comune: ["Feleacu", "Vultureni", "Jucu"],
      ...
      },
      {
        id: 10,
        judet: "Constanța",
        cities: ["Constanța", "Mangalia", "Medgidia", "Năvodari", "Eforie", "Cernavodă", "Techirghiol", "Ovidiu"],
        comune: ["Lumina", "Valu lui Traian", "Topraisar"],
    ...
    
      {
        id: 11,
        judet: "Dolj",
        cities: ["Craiova", "Calafat", "Băilești", "Filiași"],
        comune: ["Cetate", "Dobrești", "Bratovoești"],
      ...
      },
      {
        id: 12,
        judet: "Galați",
        cities: ["Galați", "Tecuci", "Târgu Bujor"],
        comune: ["Liești", "Pechea", "Barcea"],
      ...
      },
      {
        id: 13,
        judet: "Iași",
        cities: ["Iași", "Pașcani", "Hârlău"],
        comune: ["Ciurea", "Holboca", "Rediu"],
      ...
      },
      {
        id: 14,
        judet: "Ilfov",
        cities: ["Otopeni", "Buftea", "Măgurele", "Popești-Leordeni"],
        comune: ["Afumați", "Bragadiru", "Chiajna"],
      ...
      },
      {
        id: 15,
        judet: "Maramureș",
        cities: ["Baia Mare", "Sighetu Marmației", "Borșa", "Vișeu de Sus"],
        comune: ["Moisei", "Bârsana", "Botiza"],
      ...
      },
      {
        ...
        comune: ["Șimian", "Baia de Aramă", "Vânju Mare"],
      ...
      },
      {
        id: 17,
        judet: "Mureș",
        cities: ["Târgu Mureș", "Reghin", "Sighișoara", "Târnăveni"],
        comune: ["Luduș", "Iernut", "Sângeorgiu de Mureș"],
      ...
      },
      {
        id: 18,
        judet: "Neamț",
        cities: ["Piatra Neamț", "Roman", "Târgu Neamț"],
        comune: ["Bicaz", "Roznov", "Tazlău"],
      ...
      },
      {
        id: 19,
        judet: "Olt",
        cities: ["Slatina", "Caracal", "Corabia"],
        comune: ["Scornicești", "Balș", "Drăgănești-Olt"],
      ...
      },
      {
        id: 20,
        judet: "Prahova",
        cities: ["Ploiești", "Câmpina", "Băicoi", "Vălenii de Munte"],
        comune: ["Măneciu", "Blejoi", "Valea Doftanei"],
      ...
      },
      {
        id: 21,
        judet: "Sălaj",
        cities: ["Zalău", "Jibou", "Șimleu Silvaniei"],
        comune: ["Măieruș", "Bădăcin", "Bocșa"],
      ...
      },
      {
        id: 22,
        judet: "Sibiu",
        cities: ["Sibiu", "Mediaș", "Agnita", "Dumbrăveni"],
        comune: ["Rășinari", "Micheșu de Câmpie", "Șelimbăr"],
      ...
      },
      {
        id: 23,
        judet: "Suceava",
        cities: ["Suceava", "Fălticeni", "Rădăuți", "Câmpulung Moldovenesc"],
        comune: ["Gura Humorului", "Siret", "Vicovu de Sus"],
      ...
      },
      {
        id: 24,
        judet: "Teleorman",
        cities: ["Alexandria", "Roșiorii de Vede", "Turnu Măgurele"],
        comune: ["Zimnicea", "Butimanu", "Călmățuiu de Sus"],
      ...
      },
      {
        id: 25,
        judet: "Timiș",
        cities: ["Timișoara", "Lugoj", "Sânnicolau Mare", "Jimbolia"],
        comune: ["Moșnița Nouă", "Buziaș", "Deta"],
      ...
      },
      {
        id: 26,
        judet: "Tulcea",
        cities: ["Tulcea", "Măcin", "Sulina"],
        comune: ["Isaccea", "Nufăru", "Babadag"],
      ...
      },
      {
        id: 27,
        judet: "Vaslui",
        cities: ["Vaslui", "Bârlad", "Huși"],
        comune: ["Negrești", "Murgeni", "Crasna"],
      ...
      },
      {
        id: 28,
        judet: "Vâlcea",
        cities: ["Râmnicu Vâlcea", "Drăgășani", "Bălcești", "Călimănești"],
        comune: ["Măldărești", "Păușești-Măglași", "Budești"],
